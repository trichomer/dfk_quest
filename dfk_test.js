...
const masterGardenerAbi = fs
  .readFileSync("./abis/MasterGardener.json")
  .toString();
const bankAbi = fs.readFileSync("./abis/bank.json").toString();
const uniswapFactoryAbi = fs
  .readFileSync("./abis/UniswapV2Factory.json")
  .toString();
const uniswapRouterAbi = fs
  .readFileSync("./abis/UniswapV2Router02.json")
  .toString();
...
const masterGardenerContract = new ethers.Contract(
  masterGardenerAddress,
  masterGardenerAbi,
  provider
);
...
const crystalUsdcContract = new ethers.Contract(
  crystalUsdcPair,
  erc20Abi,
  provider
);
...
const jewelCrystalContract = new ethers.Contract(
  jewelCrystalPair,
  erc20Abi,
  provider
);
...
const xcrystalContract = new ethers.Contract(
  xcrystalAddress,
  erc20Abi,
  provider
);
